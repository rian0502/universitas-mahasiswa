    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 mx-auto text-center mb-4">
                ...
                <p class="mb-5">Aplikasi ini dirancang dan diperuntukkan bagi calon mahasiswa baru untuk mendaftar ke perguruan tinggi</p>
            </div>
        </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-4">
                            <div class="text-center text-md-start card-hover">
                                <div class="card-body">
                                    <h6 class="fw-light fs-1 heading-color">Pendaftaran</h6>
                                    <p class="mt-3 mb-md-0 mb-lg-3">Maiores voluptas laboriosam non dolorum perferendis fuga repellat aut. Blanditiis quos in minus. Voluptatum </p>
                                    </svg></a>
                                </div>
                            </div>
                        </div>
...
<section class="py-6 bg-100">
    ...
    <div class="container">
        <div class="row flex-center">
            ...
            <div class="col-md-4 text-center text-lg-end"> <a class="btn btn-lg btn-primary hover-top" href="/pendaftaran">Daftar
    ...
    <div class="container">
        <div class="row justify-content-between pb-2 pt-8">
            <div class="col-12 col-lg-auto mb-5 mb-lg-0"><a class="d-flex align-items-center fw-semi-bold fs-3" href="#">
                    <p class="my-3 text-100 fw-light">University of Lampung<br />Bandar Lampung, Lampung, Indonesia.</p>
            </div>
